...
This is a 'centred parameterisation'. 
...
---
# Hamiltonian Monte Carlo and convergence

why does HMC preserve the target distribution

- Hamiltonian dynamics is time reversable, so that the probability of transition from A  -> B is equal to the opposite.
- Hamiltonian transitions are volume preserving
